...
std::vector<exp_rob_lab::ErlOracle> oracle_msgs;
...
bool oracleService(exp_rob_lab::Oracle::Request &req, exp_rob_lab::Oracle::Response &res)
	{
		res.ID = winID;
		return true;
	}
...
oracle_pub = nh.advertise<exp_rob_lab::ErlOracle>( "/oracle_hint", 0 );
